...
const nearby = [
  ['01', 'Wisata alam', 'Jalan pagi, lihat pepohonan, dan nikmati udara Pacet.', 'Tanya rute'],
  ['02', 'Kuliner lokal', 'Cari kopi, jagung bakar, atau masakan rumahan di sekitar.', 'Tanya tempat makan'],
  ['03', 'Aktivitas keluarga', 'Luangkan waktu untuk bermain, berfoto, atau duduk bersama.', 'Tanya pilihan kegiatan'],
]
...
export default function Page() {
  ...
  return (
    <main>
      ...
      <section className="stats section-shell" aria-label="Kadoya House"><div><strong>700</strong><span>MDPL Ketinggian</span></div><div><strong>8</strong><span>Kamar Nyaman</span></div><div><strong>Claket</strong><span>Pacet, Jawa Timur</span></div></section>
